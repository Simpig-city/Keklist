...
public class KeklistLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder pluginClasspathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("org.xerial:sqlite-jdbc:3.53.1.0"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("org.mariadb.jdbc:mariadb-java-client:3.5.8"), "compile"));
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.zaxxer:HikariCP:7.0.2"), "compile"));
