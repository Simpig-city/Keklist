...
public class KeklistLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder pluginClasspathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("org.mariadb.jdbc:mariadb-java-client:3.5.3"), "compile"));
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.zaxxer:HikariCP:6.3.0"), "compile"));
