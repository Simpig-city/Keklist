...
public class KeklistLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder pluginClasspathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.squareup.okhttp3:okhttp-jvm:5.5.0"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("com.squareup.okio:okio-jvm:3.18.1"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("org.xerial:sqlite-jdbc:3.53.2.1"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("org.mariadb.jdbc:mariadb-java-client:3.5.10"), "compile"));
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.zaxxer:HikariCP:7.1.0"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("com.h2database:h2:2.4.240"), "compile"));
