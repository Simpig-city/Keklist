...
public class KeklistLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder pluginClasspathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("org.xerial:sqlite-jdbc:3.46.0.1"), "compile"));
        resolver.addDependency(new Dependency(new DefaultArtifact("org.mariadb.jdbc:mariadb-java-client:3.4.1"), "compile"));
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.github.johnnyjayjay:spigot-maps:2.1.1"), "compile"));
